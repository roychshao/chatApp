...
class WebSocketConfigTest {
    ...
    void configureMessageBrokerTest() {
        ...
        Mockito.verify(messageBrokerRegistry, Mockito.times(1)).enableSimpleBroker("/topic");
        Mockito.verify(messageBrokerRegistry, Mockito.times(1)).setApplicationDestinationPrefixes("");
    }
    ...
    void registerStompEndpointsTest() {
        ...
        Mockito.verify(stompEndpointRegistry, Mockito.times(1)).addEndpoint("/chatApp");
    }
}
