...
export const getUserFriends: any = createAsyncThunk(
  "user/getUserFriends",
  async (userId: string) => {
...
export const addUserFriend: any = createAsyncThunk(
  "user/addUserFriends",
  async (meAndFriend: user[]) => {
    const res = await axios.post(
      "http://localhost:8080/api/user/friend/add",
      meAndFriend,
      { withCredentials: true },
    );
    return res.data;
